...
export class VGA {
  ...
  // Opaque plot into the presentation buffer (overwrites). Used for the
  // checkerboard floor, which is the scene's solid background under the
  // additively-blended glenz polygons. x,y assumed in-bounds.
