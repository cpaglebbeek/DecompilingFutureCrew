...
const Z_POS = 7100; // camera/object baseline depth (zpos). Nudged back from the
// faithful 7500 so the projected object spans ~79% width — matching the
// reference's black-margin framing (ref_11/13 measure 77-82%w) rather than
// touching the screen edges; travel/bounce scale with it (camera-pull look).
